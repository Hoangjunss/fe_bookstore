    ...
    function getCategories(page, size, objectFilter) {
        ...
        axios.post(`http://localhost:8080/api/categories/search?page=${page}&size=${size}`, objectFilter)
            .then(response => {
                ...
                for (let i = 0; i < categories.length; i++) {
                    ...
                    let row = `<tr>
                        ...
                        <td>${statusText}</td>
                        <td>
                            <a href="/admin/category/updateCategory/${data.id}.html" class="btn btn-warning btn-sm">Chi tiết</a>
