...
<head>
    ...
    <meta content="Quản lý phiếu nhập kho cho cửa hàng" name="description"/>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Danh Sách Phiếu Nhập Kho</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            ...
                            <!-- Bảng Danh Sách Warehouse Receipt -->
...
<script src="../../../static/call-api/employee/warehouse/list-warehousereceipt.js"></script>
