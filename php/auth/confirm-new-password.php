            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    ...
                    <div class="card-body p-4">
                        ...
                        <!-- form -->
                        <form class="mt-3" action="/save-new-password" method="post" id="myForm"><!-- Thay thế th:action bằng action với đường dẫn tĩnh -->

                            <div class="form-group">
                                <label for="old_password">Mật khẩu cũ của bạn</label>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 text-center">
                                <p class="text-muted mb-0">Bạn không nhận được email? <a href="re-send.html"
                                    ...
                                    Lại</b></a></p>
                                <p class="text-muted mb-0">Bạn đã có tài khoản? <a href="pages-login.html"
